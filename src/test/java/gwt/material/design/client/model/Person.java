...
public class Person implements HasDataCategory, Serializable {
    ...
    public Person(int id, String picture, String firstName, String lastName, String phone, String category) {
        this.id = id;
    ...
    @Override
    public CategoryPair getDataCategory() {
        return new CategoryPair(getCategory());
    }
