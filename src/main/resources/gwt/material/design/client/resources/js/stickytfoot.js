  ...
  function Plugin(el, options) {
    ...
    base.init = function () {
      base.$el.each(function () {
        ...
        base.$originalHeader = $('tfoot:first', this);
    ...
    base.toggleHeadersAutoLoad = function() {
      base.toggleHeaders(true);
    }

    base.toggleHeaders = function (autoLoad) {
      if (base.$el) {
        base.$el.each(function() {
          var $this = $(this),
              newLeft,
          ...
          if (scrolledPastTop || autoLoad /*&& notScrolledPastBottom*/) {
