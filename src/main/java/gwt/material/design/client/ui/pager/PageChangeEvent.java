...
public class PageChangeEvent extends GwtEvent<PageChangeEvent.PageChangeHandler> {
    ...
    public interface PageChangeHandler extends EventHandler {
        void onChangePage(PageChangeEvent event);
    }

    public static final Type<PageChangeHandler> TYPE = new Type<>();
    ...
    public static void fire(HasHandlers source, Integer page) {
        source.fireEvent(new PageChangeEvent(page));
    }
